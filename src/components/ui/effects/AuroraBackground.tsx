  ...
  return (
    <div className={cn('relative isolate overflow-hidden', className)}>
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/3 -right-40 h-[520px] w-[520px] rounded-full bg-emerald-500/10 blur-3xl animate-aurora-2" />
        <div className="absolute -bottom-40 left-1/3 h-[460px] w-[460px] rounded-full bg-teal-500/8 blur-3xl animate-aurora-3" />
